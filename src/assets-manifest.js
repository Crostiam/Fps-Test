// Fill this with your asset files. Paths under "public/assets" can be referenced with "/assets/..."
// Examples below are commented; uncomment and point to your files when you add them.

export const ASSET_MANIFEST = {
  models: {
    // First-person weapons (attach to camera)
    // 'gun_pistol_fp': '/assets/models/weapons/pistol_fp.glb',
    // 'gun_rifle_fp': '/assets/models/weapons/rifle_fp.glb',
    // 'gun_shotgun_fp': '/assets/models/weapons/shotgun_fp.glb',
    // 'gun_smg_fp': '/assets/models/weapons/smg_fp.glb',

    // World pickups/items shown on pedestals
    // 'pickup_weapon_rifle': '/assets/models/pickups/rifle_world.glb',
    // 'pickup_weapon_shotgun': '/assets/models/pickups/shotgun_world.glb',
    // 'pickup_weapon_smg': '/assets/models/pickups/smg_world.glb',
